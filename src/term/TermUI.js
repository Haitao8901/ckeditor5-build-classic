...
export default class TermUI extends Plugin {
    init() {
        console.log( 'TermUI#init() got called' );
        ...
        editor.ui.componentFactory.add( 'term', locale => {
            ...
            this.listenTo( dropdownView, 'execute', evt => {
                editor.execute( 'term', { value: evt.source.commandParam } );
